...
static int	check_length(char* buf)
{
	int	i;
...
static int	get_prefix(char* buf, Message& res)
{
	int	i;
...
static void	get_command(char *buf, Message& res, int& i)
{
	int	start = i;
...
static void	get_params(char *buf, Message& res, int& i)
{
	int	start;
	std::string	temp;
